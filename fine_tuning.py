    ...
    for _ in range(train_iterator):
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if step%1000 == 0 and step <= len(train_dataloader)//1000:
                ...
                if results['acc'] > best_acc and results['sens'] >=0.1:
                ...
                elif results['acc'] == best_acc and results['sens'] >= best_acc_sens:
                    best_acc = results['acc']
                    best_acc_spec = results['spec']
                    best_acc_sens = results['sens']
                    # acc_HD = results['acc_HD']
...
def main(n):
    ...
    args.dmr = n
    args.data_dir = './ft_data_for_train/HCC_model_comparison'
    # args.weight = weight
